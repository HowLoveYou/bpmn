...
const customElements = ['bpmn:StartEvent', 'bpmn:EndEvent', 'bpmn:Task', 'bpmn:ExclusiveGateway'] // 自定义元素的类型
...
const customShapeAction = [{
  ...
  // },
  {
    ...
    action: ['bpmn:ExclusiveGateway', 'activity', 'icon-custom icon-custom-exclusive-gateway', '条件']
  },
  // {
